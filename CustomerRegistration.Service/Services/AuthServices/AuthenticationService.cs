...
namespace CustomerRegistration.Service.Services.AuthServices
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        private readonly IGenericRepository<UserRefreshToken, UserRefreshToken> _userRefreshTokenRepository;
        public AuthenticationService(ITokenService tokenService, UserManager<UserApp> userManager, IUnitOfWork unitOfWork, IGenericRepository<UserRefreshToken, UserRefreshToken> userRefreshTokenRepository)
        {
